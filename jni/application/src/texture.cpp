...
int
SurfaceOpenGL::draw(float x, float y, Uint8 alpha, bool update_w_h)
{
    GLfloat vertices[] = {
        x,     y,
        x + w, y,
...
int
SurfaceOpenGL::draw_bg(Uint8 alpha, bool update_w_h)
{
    GLfloat vertices[] = {
        0.0f,   0.0f,
        640.0f, 0.0f,
...
int
SurfaceOpenGL::draw_part(float sx, float sy, float sw, float sh, float dx, float dy, Uint8 alpha, bool update_w_h)
{
    GLfloat vertices[] = {
        dx,      dy,
        dx + sw, dy,
    ...
    // Milestone 1 uses .w and .h for members
    GLfloat tx1 = sx / w;
    GLfloat ty1 = sy / h;
    GLfloat tx2 = (sx + sw) / w;
    GLfloat ty2 = (sy + sh) / h;
...
int
SurfaceOpenGL::draw_stretched(float x, float y, int w, int h, Uint8 alpha, bool update_w_h)
{
    GLfloat vertices[] = {
        x,         y,
        x + (float)w, y,
