...
class Globals {
	...
	// Should be zip file
	public static String DataArchiveAsset = "supertux_data.zip";
	...
	public static String ReadmeText = "^Wait while SuperTux extracts data files, this only occurs once.^You can press home, the download will continue.^^Do NOT turn screen off or your connection will end & you'll have to download again.^".replace("^","\n");
